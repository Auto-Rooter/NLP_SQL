...
export class Datasource1742684003623 implements MigrationInterface {
    name = 'Datasource1742684003623'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "datasource" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "projectId" character varying NOT NULL, "databaseUrl" character varying, "databaseName" character varying, "port" character varying, "username" character varying, "password" character varying, "type" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5527742558a95839f5e521ada64" UNIQUE ("projectId"), CONSTRAINT "PK_9a969f486c5f1abd362afe73724" PRIMARY KEY ("id"))`);
