...
export class Chartinfo1742684781008 implements MigrationInterface {
    name = 'Chartinfo1742684781008'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "chart_info" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "chartName" character varying NOT NULL, "datasourceId" uuid NOT NULL, "databaseUrl" character varying, "chartType" character varying NOT NULL, "xAxis" character varying NOT NULL, "yAxis" character varying NOT NULL, "prompt" character varying NOT NULL, "queryData" text NOT NULL, "chartData" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ec886493273a391a5d7706711e0" PRIMARY KEY ("id"))`);
